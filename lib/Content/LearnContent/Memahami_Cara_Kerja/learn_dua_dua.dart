import 'package:cpp_course/Content/LearnContent/Memahami_Cara_Kerja/learn_dua.dart';
import 'package:cpp_course/Content/LearnContent/Memahami_Cara_Kerja/learn_dua_tiga.dart';

import 'package:flutter/material.dart';

class BelajarDua2 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      debugShowCheckedModeBanner: false,
      home: BelajarDua2Page(),
    );
  }
}

class BelajarDua2Page extends StatefulWidget {
  @override
  _BelajarDua2State createState() => _BelajarDua2State();
}

class _BelajarDua2State extends State<BelajarDua2Page> {
  List<String> sentences = [
    "Sekarang, Anda pasti bertanya-tanya bagaimana perintah yang kami tulis dalam bahasa Inggris dipahami oleh computer dan bagaimana tindakannya?",
    "Izinkan saya mencoba menjelaskannya dalam lima langkah sederhana",
  ];
  ...
  void _navigateToAnotherPage() {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => BelajarDua3()),
    );
  }
